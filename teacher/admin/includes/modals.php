     ...
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <fieldset>
            <div class="form-group">
                    <label>Passing Points for whole exam</label>
                    <input type="number" name="passPoint" id="" class="form-control" placeholder="Pass Points" autocomplete="off">
                </div>
            ...
            <div class="form-group">
                <label>Points</label>
                <input type="number" name="enterPoint" id="" class="form-control" placeholder="Points" autocomplete="off">
            </div>
