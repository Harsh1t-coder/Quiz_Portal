        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div>
                        <?php
                         if(isset($selExam['ex_title']))
                         echo $selExam['ex_title']; 
                         ?>
                          <div class="page-title-subheading">
                            <?php 
                            if(isset($selExam['ex_description']))
                            echo $selExam['ex_description']; ?>
                          </div>
                    ...
                    <div class="widget-content-right">
                        <div class="widget-numbers text-white">
                            ...
                            <span>
                                ...
                                <?php 
                                  //  if(isset($selExam['ex_queslimit_display']))
                                    $over  = $selExam['ex_questlimit_display'];
                                 ?>
                            </span> / <?php if(isset($over)) echo $over; ?>
                        </div>
                    </div>
                </div>
            </div>
